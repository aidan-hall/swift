...
public struct CNEGet<T: ~Escapable>: ~Escapable {
  let ne: T
...
extension CNEGet: Escapable where T: Escapable {}
extension CNEGet: IGet { } // OK: If it is Escapable, it can conform to IGet
